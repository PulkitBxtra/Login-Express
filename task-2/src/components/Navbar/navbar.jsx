  ...
  return (
    ...
    <div className="flex flex-col -ml-1">
      <div className="flex flex-row justify-center items-center gap-3 my-5">
        ...
        <div className="text-white text-xl">Realply</div>
      </div>

      <div className="mt-5">
        <Cards title="Dashboard" src="https://i.imgur.com/Bzet7Ep.png"></Cards>

        <Cards title="Messages" src="https://i.imgur.com/5SxQ0p2.png"></Cards>

        <Cards title="Calender" src="https://i.imgur.com/wDsFm2K.png"></Cards>

        <Cards title="Campaigns" src="https://i.imgur.com/YZENmXB.png"></Cards>
      </div>

      <div className="mt-10">
        <Cards title="Settings" src="https://i.imgur.com/tXfim7F.png"></Cards>
        <Cards title="Help" src="https://i.imgur.com/WuniFGh.png"></Cards>
      </div>
    </div>
    
    <div className="text-white mx-9 mt-4">
        <div className="border border-[#D4D4FC]  rounded-2xl">
            <div className="flex  mt-3">
                <p className="inline-block w-[120px] whitespace-normal break-words text-xs font-bold">Your free trail is about to end in</p>
            </div>
                <p className="text-white text-3xl flex ml-4 font-bold">10 Days</p>

                <p className="text-[#D4D4FC] text-xs text-left ml-4">You will not get billed during your free trail</p>
                <p className="text-[#D4D4FC] text-xs text-left ml-4 mt-3">To keep your projects running after the trial end, upgrade to a paid option.</p>
            
                <div className="bg-[#D4D4FC]/[.12] p-2 m-2 border border-[#D4D4FC] rounded-lg my-3 cursor-pointer">
                    <p>Upgrade</p>
                </div>
    ...
    <div className="mt-5 -ml-1">
        <Cards title="Sign Out" src="https://i.imgur.com/IK3B0mO.png"></Cards>
    </div>
